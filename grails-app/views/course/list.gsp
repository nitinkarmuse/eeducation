			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="syllabus" title="${message(code: 'course.syllabus.label', default: 'Syllabus')}" />
					
						<th><g:message code="course.institute.label" default="Institute" /></th>
				...
				<g:each in="${courseInstanceList}" status="i" var="courseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: courseInstance, field: "syllabus")}</td>
					
						<td>${fieldValue(bean: courseInstance, field: "institute.name")}</td>
